...
/**
 * Implements {@link GenericEventImpl} to provide filterable events based on generic type data.
 *
 ...
 */
public class GenericEvent<T> extends Event implements GenericEventImpl<T> {
