 ...
 *
 * Contains factory methods to construct an instance {@link #create()} and {@link #create(EventExceptionHandlerImpl)}
 */
public interface EventBusImpl {
     ...
     * @return true if the event was {@link Cancelable} cancelled
     */
    boolean post(Event event, EventBusInvokeDispatcherImpl wrapper);
