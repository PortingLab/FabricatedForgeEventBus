...
import org.portinglab.fabricatedeventbus.ListenerList;
import org.portinglab.fabricatedeventbus.LockHelper;
...
public class EventListenerHelper {
    ...
    static boolean hasResult(Class<?> eventClass) {
        return hasAnnotation(eventClass, Event.HasResult.class, hasResult);
    }
