...
public class EventBusErrorMessage implements Message, StringBuilderFormattable {
    ...
    private final EventListenerImpl[] listeners;
    private final Throwable throwable;

    public EventBusErrorMessage(final Event event, final int index, final EventListenerImpl[] listeners, final Throwable throwable) {
        //this.event = event;
        this.index = index;
